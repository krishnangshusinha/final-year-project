...
const DrainageRepairPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchUniqueIDs = async () => {
            ...
            try{
                const {data} = await axios.get("https://final-year-project-9p1g.onrender.com/admin/drainage/repairs");
    ...
    const deleteComplaint = async (id) => {
        ...
        try{
            const {data} = await axios.delete(`https://final-year-project-9p1g.onrender.com/admin/delete/drainage/repairs/${id}`)
    ...
    const handleStatus = async (id , status) => {
        try {
            const {data} = await axios.put(`https://final-year-project-9p1g.onrender.com/admin/drainage/repair/${id}/${status}`)
            ...
            <div class="p-4 sm:ml-64 bg-blue-50">
                <div class="p-4 rounded-lg  dark:border-gray-700 mt-14">
                    ...
                    <div className="pr-4 pt-4 pb-4 flex flex-col gap-2 font-bold mb-6">
                        <p className="text-4xl">Drainage Repair Request Complaints</p>
                    </div>
                                    ...
                                    <div class="md:flex md:items-center mt-6 mb-6 text-black ml-4">
                                        ...
                                        <div class="md:w-3/4">
                                            <select className="select select-info border-2 border-green-500 w-full max-w-xl text-xl" onChange={(event) => ( setPhone(event.target.value) )}>
                                                ...
                                                <option value="+911234567880">Technician I</option>
                                                <option value="+911234567881">Technician J</option>
                                                <option value="+911234567882">Technician K</option>
                                                <option value="+911234567883">Technician L</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="md:flex md:items-center mt-10 mb-6 text-black ml-4">
...
export default DrainageRepairPage;