...
const ElectricityRepairPage = () => {
    ...
    useEffect(() => {
        ...
        // first fetching all the Electricity Install requests
        const fetchUniqueIDs = async () => {
            
            try{
                const {data} = await axios.get("https://final-year-project-9p1g.onrender.com/admin/electricity/repairs");
                ...
                console.log(error);
                alert("Error in getting Electricity Install requests");
            }
    ...
    const deleteComplaint = async (id) => {
        ...
        try{
            const {data} = await axios.delete(`https://final-year-project-9p1g.onrender.com/admin/delete/electricity/repairs/${id}`)
    ...
    const handleStatus = async (id , status) => {
        try {
            const {data} = await axios.put(`https://final-year-project-9p1g.onrender.com/admin/electricity/repair/${id}/${status}`)
            ...
            <div class="p-4 sm:ml-64 bg-blue-50">
                <div class="p-4 rounded-lg  dark:border-gray-700 mt-14">
                    ...
                    <div className="pr-4 pt-4 pb-4 flex flex-col gap-2 font-bold mb-6">
                        <p className="text-4xl">Electricity Repair Request Complaints</p>
                    </div>
                                    ...
                                    <div class="md:flex md:items-center mt-6 mb-6 text-black ml-4">
                                        ...
                                        <div class="md:w-3/4">
                                            <select className="select select-info border-2 border-green-500 w-full max-w-xl text-xl" onChange={(event) => ( setPhone(event.target.value) )}>
                                                ...
                                                <option value="+919832097879">Technician A</option>
                                                <option value="+918972886921">Technician B</option>
                                                <option value="+918001391639">Technician C</option>
                                                <option value="+919883874371">Technician D</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="md:flex md:items-center mt-10 mb-6 text-black ml-4">
...
export default ElectricityRepairPage;