        ...
        <>
            ...
            <div class="p-4 sm:ml-64 bg-blue-50">
                <div class="p-4 rounded-lg  dark:border-gray-700 mt-14 mb-10">
                    ...
                    <p className="text-black text-5xl font-bold">History of assigned complaints</p>
                </div>
                <div class="grid grid-cols-4 gap-4">
                {
                    worker.complaints.map((c, index) => (
                        <>
                        { index != worker.complaints?.length - 1 ?
                        <div className="card bg-blue-600 text-primary-content w-96">
                            <div className="card-body">
                                <p className="text-2xl font-bold">Complaint ID - <span className="font-medium text-lg">{c}</span></p>
                                <div className="card-actions flex justify-between mt-2">
                                    <div className="flex flex-row gap-2">
                                        <p className="font-bold mt-2 p-1">Resolved</p>
                                        <SiTicktick className="mt-4"/>
                                    </div>
