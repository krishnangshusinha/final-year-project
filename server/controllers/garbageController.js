const installModel = require("../models/garbage/installModel");
const repairModel = require("../models/garbage/repairModel");
const uniqueIDModel = require("../models/uniqueID");

// creating an garbage install complaint
...
// creating an garbage repair complaint
